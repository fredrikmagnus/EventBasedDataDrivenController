...
class Controller(BaseModel):
    ...
    tau: float = Field(0.1, description="Time constant for trace decay")
    ...
    spike_force: float = Field(1.0, description="Spike force magnitude")
...
class Simulation(BaseModel):
    ...
    dt: float = Field(0.001, description="Simulation time step in seconds")
